...
def saved(res, database='1', db_name='test', username='root', passwd='a8416459'):  # 保存到数据库,mysql或mongodb
    if database == '1':
        try:
...
def down_manager(urls):
    gevent.joinall([gevent.spawn(download, i)
                    for i in urls])  # spawn(func,arg)
...
if __name__ == '__main__':
    ...
    fromwho = 'kushao1267@aliyun.com'
    password = 'a8416459'
    towho = '461698053@qq.com'
    print content
